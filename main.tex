...
\section{Tesinas}
\subsection{Links de interés de la Tesina de LCC}
Sitio Comunidades de la Tesina: \url{https://comunidades.campusvirtualunr.edu.ar/course/view.php?id=6742}
Página oficial de la Tesina de LCC: \url{https://dcc.fceia.unr.edu.ar/es/lcc/tesinas-grado}
...
\subsubsection{Búsqueda y Análisis de Papers}
    \begin{itemize}
