...
\begin{itemize}
    ...
    \item Si una imagen es un screenshot o una fotografía, debe estar en formato \lstinline{png} o \lstinline{jpg} de alta calidad (300 dpi, o un máximo de $1920\times 1080$ píxeles).
\end{itemize}
