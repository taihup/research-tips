...
\section{Comentarios sobre Conceptos Previos}
%
...
En este capítulo se deben describir los experimentos realizados para validar el método propuesto. Se deben incluir tablas y gráficos para mostrar los resultados obtenidos. Es importante comparar los resultados obtenidos con los de otros métodos existentes en la literatura.
...
\begin{itemize}
    ...
    \item Agregar un guión extra a las páginas, porque sino no se visualiza bien. Ej: 234-242 $\rightarrow$ 234--242
    \item Siempre debe estar el DOI y/o ISBN de la referencia cuando esten disponibles.
\end{itemize}
